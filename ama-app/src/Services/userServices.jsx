...
export const servicos = [
    {
        ...
        preco: 90,
        prazo: 'Semanal',
        descricao: 'A terapia cognitivo-comportamental, ou TCC, é uma abordagem psicoterapêutica que se concentra na identificação e modificação de padrões de pensamento e comportamento disfuncionais. A terapia cognitivo-comportamental, ou TCC, é uma abordagem psicoterapêutica que se concentra na identificação e modificação de padrões de pensamento e comportamento disfuncionais.',
        premium: true,
    },
    {
        imagem: 'https://thispersondoesnotexist.com',
